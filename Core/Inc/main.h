...
#define FB_SPEED 2000               // Translation brush group running speed
#define UD_SPEED 2000               // Lifting brush group running speed
#define B_ARM_TARG_PULSE 50000      // Big arm end point pulse value
#define B_AEM_SPEED 2000            // Big arm running speed
#define S_ARM_TARG_PULSE 50000      // Small arm end point pulse value
#define S_ARM_SPEED 2000            // Small arm running speed

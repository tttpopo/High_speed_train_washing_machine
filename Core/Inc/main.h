...
#define IN_RES_1_Pin GPIO_PIN_10
#define IN_RES_1_GPIO_Port GPIOD
#define IN_RES_2_Pin GPIO_PIN_11
#define IN_RES_2_GPIO_Port GPIOD
#define IN_RES_3_Pin GPIO_PIN_12
#define IN_RES_3_GPIO_Port GPIOD
#define IN_RES_4_Pin GPIO_PIN_13
#define IN_RES_4_GPIO_Port GPIOD
#define EMERG_KEY_Pin GPIO_PIN_8
#define EMERG_KEY_GPIO_Port GPIOA
#define DRUM_2_Pin GPIO_PIN_0
#define DRUM_2_GPIO_Port GPIOD
#define DRUM_3_Pin GPIO_PIN_3
#define DRUM_3_GPIO_Port GPIOD
#define SPOT_LIGHT_1_Pin GPIO_PIN_7
#define SPOT_LIGHT_1_GPIO_Port GPIOD
#define PUMP_5_Pin GPIO_PIN_3
#define PUMP_5_GPIO_Port GPIOB
#define PUMP_6_Pin GPIO_PIN_4
#define PUMP_6_GPIO_Port GPIOB
#define PUMP_7_Pin GPIO_PIN_5
#define PUMP_7_GPIO_Port GPIOB
#define DRUM_1_Pin GPIO_PIN_6
...
#define S_ARM_SPEED 20000            // Small arm running speed

...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, DRUM_2_Pin|DRUM_3_Pin|SPOT_LIGHT_1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, PUMP_5_Pin|PUMP_6_Pin|PUMP_7_Pin|DRUM_1_Pin
  ...
  /*Configure GPIO pins : PDPin PDPin PDPin PDPin
                           PDPin PDPin */
  GPIO_InitStruct.Pin = MOTO_SARM_LIMIT_U_Pin|MOTO_SARM_LIMIT_D_Pin|IN_RES_1_Pin|IN_RES_2_Pin
                          |IN_RES_3_Pin|IN_RES_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  ...
  GPIO_InitStruct.Pin = DRUM_2_Pin|DRUM_3_Pin|SPOT_LIGHT_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin PBPin */
  GPIO_InitStruct.Pin = PUMP_5_Pin|PUMP_6_Pin|PUMP_7_Pin|DRUM_1_Pin
